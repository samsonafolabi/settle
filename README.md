...
Every deposit is validated by Accord, Somnia’s onchain validation layer, before vault finalisation and recorded through a trust pipeline so users can inspect what happened.
